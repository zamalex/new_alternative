...
import '../main.dart';
class LocalProductOwnerAdd extends StatefulWidget {
  const LocalProductOwnerAdd({super.key, required this.isBaycoot, required this.flag});

  final int isBaycoot;
  final int flag;
  @override
  State<LocalProductOwnerAdd> createState() {
    // TODO: implement createState
    return _LocalProductOwnerAdd();
  }
}

class _LocalProductOwnerAdd extends State<LocalProductOwnerAdd> {
  String? token;
                          ...
                          InkWell(
                            onTap: () {
                              if(_formkey.currentState!.validate()) {
                                ...
                                if (widget.isBaycoot == 0) {
                                  _saveItemnotbaycoot();
                                } else if (widget.isBaycoot == 1) {
                                  _saveItembaycoot();
                                }
                              }
                            },
